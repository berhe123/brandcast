...
const FEATURES = [
  ...
  },
  {
    ...
    body: 'A realistic offline demo engine means VibePost runs fully without any API keys. Add provider keys to go live in seconds.',
...
const STEPS = [
  ...
  { icon: Send, title: 'Schedule & publish', body: 'Refine, queue it to your calendar, and let VibePost ship it automatically.' },
]
...
const TESTIMONIALS = [
  ...
  { quote: 'We run nine client brands from one place now. VibePost paid for itself in the first week.', name: 'Daniel K.', role: 'Founder, content agency' },
...
const FAQS = [
  { q: 'Do I need an OpenAI or Anthropic key to use VibePost?', a: 'No. VibePost ships with a realistic offline engine so everything works out of the box. Add any provider key (Anthropic, OpenAI, Gemini, DeepSeek) and the matching models instantly switch to live generation.' },
  { q: 'What makes the AI Router different from other tools?', a: 'Most tools pipe every request to one model. VibePost scores each model on the skills your specific task needs — hooks, brand voice, long-form, multilingual — then routes to the best one, or fuses two complementary models into a single best-of-both post.' },
      ...
      <section className="relative">
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 pt-20 pb-16 md:pt-28 md:pb-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <span className="pill-green mb-6">
                <Sparkles size={13} /> Multi-model AI · 4 providers · 7 models
              </span>
              ...
              <p className="mt-6 text-lg text-slate-700 leading-relaxed max-w-xl">
                VibePost routes each marketing task to the model that does it best — and fuses two when
      ...
      <section className="max-w-6xl mx-auto px-5 sm:px-6 py-20 md:py-24">
        <Reveal className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-5 text-lg text-slate-700 leading-relaxed">
            ...
            second-guess which model wrote it better. VibePost collapses the whole workflow into one
      ...
      <section id="how" className="relative py-20 md:py-24 scroll-mt-20">
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6">
          <Reveal className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="font-display text-3xl md:text-4xl font-bold tracking-tight text-slate-900">How VibePost works</h2>
          </Reveal>
    ...
    <div className="card-light ring-1 ring-green-500/30 p-5 sm:p-6 max-w-md mx-auto lg:mx-0 shadow-lg">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <LogoMark size={28} />
          <span className="text-sm font-semibold text-slate-900">VibePost Studio</span>
        </div>
      ...
      <div className="rounded-xl bg-slate-100 border border-slate-200 p-3 mb-4">
        ...
        <p className="text-sm text-slate-800">Announce our new launch — make it feel exclusive, warm, and impossible to scroll past.</p>
      </div>
